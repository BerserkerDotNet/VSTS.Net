...
namespace VSTS.Net.Interfaces
{
    public interface IVstsWorkItemsClient
    {
        ...
        Task<WorkItem> GetWorkItemAsync(string project, int workItemId, DateTime? asOf = null, string[] fields = null);
        ...
        Task<IEnumerable<WorkItem>> GetWorkItemsAsync(string project, int[] ids, DateTime? asOf = null, string[] fields = null);
        ...
        /// <returns></returns>
        Task<bool> DeleteWorkItemAsync(string project, int id, bool destroy = false);
